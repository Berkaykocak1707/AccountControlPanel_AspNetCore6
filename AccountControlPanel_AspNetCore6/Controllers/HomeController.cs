...
namespace AccountControlPanel_AspNetCore6.Controllers
{
    public class HomeController : Controller
	{
        ...
        {
            var apiKey = _configuration["AbstractApi:ApiKey"]; // API anahtarınızı buraya yerleştirin
        ...
        public async Task<IActionResult> LoginAsync(string returnUrl = "")
		{
            ...
            {
                var uri = new Uri("https://localhost:7268" + returnUrl);
        ...
        public async Task<IActionResult> ForgotPassword(string username)
        {
            ...
            await _signInManager.SignOutAsync();
            TempData["ErrorMessage"] = "The password reset link has been sent, please check your mailbox.";
            return RedirectToAction(nameof(Login));
        }
